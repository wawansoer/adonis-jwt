...
export const logger: LoggerConfig = {
 ...
 |--------------------------------------------------------------------------
 |
 | Configure the logger transport to write logs to a file.
 |
 */
	transport: 'file',
	...
	|--------------------------------------------------------------------------
	|
	| Configure the file transport for writing logs to a file.
	|
	*/
	file: {
		enabled: true,
		filename: 'logs/app.log', // Specify the path and filename for the log file
	},
}
